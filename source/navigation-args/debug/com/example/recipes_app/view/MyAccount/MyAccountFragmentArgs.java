...
public class MyAccountFragmentArgs implements NavArgs {
  ...
  private MyAccountFragmentArgs(HashMap argumentsMap) {
  ...
  public static MyAccountFragmentArgs fromBundle(@NonNull Bundle bundle) {
    MyAccountFragmentArgs __result = new MyAccountFragmentArgs();
  ...
  public boolean equals(Object object) {
    ...
    MyAccountFragmentArgs that = (MyAccountFragmentArgs) object;
  ...
  public static class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(MyAccountFragmentArgs original) {
    ...
    public MyAccountFragmentArgs build() {
      MyAccountFragmentArgs result = new MyAccountFragmentArgs(arguments);
      return result;
    }
